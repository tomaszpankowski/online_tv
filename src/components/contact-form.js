...
class ContactForm extends Component {
    ...
    render() {
        return (
            <Container fluid className={"contact-s2 align-items-center px-0 py-5 border-top border-info d-flex minh-50vh " + this.props.classExt}>
                        ...
                        <Form className="text-start w-100 border border-info p-4 rounded bg-dark shadow text-info opacity-9 fw-bold"
                            ...
                            <Form.Group controlId="formMessage" className="mt-3">
                                ...
                                <Form.Control as="textarea"
                                    rows={4}
                                    className="text-secondary border-info"
                                    maxLength="250"
                                    name="messageText"
                                    onChange={this.updateFormData.bind(this)} 
