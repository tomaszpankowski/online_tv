...
class MoviesS4 extends Component{
    render(){
        return(    
            <Container fluid className="movies-s4 d-flex minh-50vh align-items-center py-5 border-top border-info bg-secondary">
