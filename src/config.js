...
const appCfg = {
    routes:[
        ...
        {navItem:true, exact:true, path:"/movies",name:"Movies",view:<Movies/>},
        {navItem:true, exact:true, path:"/films",name:"Films",view:<Films/>},
...
const APP_LINKS = {
    messages: "http://localhost/online_tv/public/message.php",
    register: "register.php",
    users: "http://localhost/online_tv/public/user.php"
};
